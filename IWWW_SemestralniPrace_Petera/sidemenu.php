<div class="sidemenu">
    ...
    <ul>
        ...
        <li><a href="#"><i class="far fa-futbol"></i>&nbsp;&nbsp;Míčky</a></li>
        <li><a href="#"><i class="fas fa-glasses"></i>&nbsp;&nbsp;Doplňky</a></li>
        <li><a href="#"><i class="fas fa-tshirt"></i>&nbsp;&nbsp;Oblečení</a></li>
        <li><a href="#"><i class="fas fa-crosshairs"></i>&nbsp;&nbsp;Branky</a></li>
    </ul>
</div>